...
def load_data(nrows):
    ...
    data[DATE_TIME] = pd.to_datetime(data["crash_date"] + " " + data["crash_time"], infer_datetime_format=True)
...
st.header("Number of accidents occuring during a given time of the day")
